...
if val == 1:
    ...
    # benchmark_function = benchmark(lb, ub, dim)
    # obj_func = benchmark_function.F5_function()
    ...
    # func_id = [1] + list(range(3, 4)) # CEC 2017
    # func_id = list(range(1, 3))  # CEC 2020 - 2022
    ...
    #         # CEC 2017 (F1 - F30)
    #         func_class = getattr(cec2017, func_name)
    #         # CEC 2020 (F1 - F10)
    #         func_class = getattr(cec2020, func_name)
    #         # CEC 2022 (F1 - F12)
    #         func_class = getattr(cec2022, func_name)
